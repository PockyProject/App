...
public class GroupMenuAdapter extends RecyclerView.Adapter<GroupMenuAdapter.GroupMenuViewHolder> {
    ...
    public GroupMenuAdapter(List<Integer> imageList, List<String> sideName, List<String> arrName, OnItemClickListener listener) {
    ...
    @Override
    public GroupMenuViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_group, parent, false);
        return new GroupMenuAdapter.GroupMenuViewHolder(view);
    }

    @Override
    public void onBindViewHolder(GroupMenuViewHolder holder, int position) {
    ...
    class GroupMenuViewHolder extends RecyclerView.ViewHolder {
        ImageView imageView;
        TextView textView;

        public GroupMenuViewHolder(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.group_ImageView);
