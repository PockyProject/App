...
public class ToppingAdapter extends RecyclerView.Adapter<ToppingAdapter.ToppingViewHolder> {
    ...
    public ToppingAdapter(List<Integer> imageList, List<String> souceName, List<String> qrSouceName, OnItemClickListener listener) {
    ...
    class ToppingViewHolder extends RecyclerView.ViewHolder {
        ...
        public ToppingViewHolder(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.topping_ImageView);
            textView = itemView.findViewById(R.id.topping_TextView);
