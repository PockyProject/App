...
public class WrappAdapter extends RecyclerView.Adapter<WrappAdapter.WrappViewHolder> {
    ...
    public WrappAdapter(List<Integer> imageList, List<String> sideName, OnItemClickListener listener) {
    ...
    @Override
    public WrappViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_wrapp, parent, false);
        return new WrappViewHolder(view);
    }

    @Override
    public void onBindViewHolder(WrappViewHolder holder, int position) {
    ...
    class WrappViewHolder extends RecyclerView.ViewHolder {
        ImageView imageView;
        TextView textView;

        public WrappViewHolder(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.wrapp_ImageView);
            textView = itemView.findViewById(R.id.wrapp_TextView);
