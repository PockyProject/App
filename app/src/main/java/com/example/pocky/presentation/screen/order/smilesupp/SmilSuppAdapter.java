...
public class SmilSuppAdapter extends RecyclerView.Adapter<SmilSuppAdapter.SmileSupViewHolder> {
    ...
    public SmilSuppAdapter(List<Integer> imageList, List<String> sideName, OnItemClickListener listener) {
    ...
    @Override
    public SmileSupViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_smilesup, parent, false);
        return new SmileSupViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SmileSupViewHolder holder, int position) {
    ...
    class SmileSupViewHolder extends RecyclerView.ViewHolder {
        ImageView imageView;
        TextView textView;

        public SmileSupViewHolder(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.smilesup_ImageView);
            textView = itemView.findViewById(R.id.smilesup_TextView);
